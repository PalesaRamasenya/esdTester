...
function Landing() {
    ...
    return (
        ...
        <aside className='manager-sidebar'>
            ...
            <Link to='/issues' className='manager-dash-link'> View Issues</Link>
            <br/>
            <br/>
            <Link to='/assigned' className='manager-dash-link'>View Assigned Issues</Link>
            <br/>
            <br/>
            <Link to='/help' className='manager-dash-link'>  Help </Link>
            <br/>
            <br/>
                ...
                <circle cx="80" cy="80" r="70" stroke-linecap="round" />
                    ...
                    <div className='progress-container'>
                        <div className='status'>
                            <div className='outer'>
                                <div className='inner'>
                                    <div className='number' data-num='16'>
